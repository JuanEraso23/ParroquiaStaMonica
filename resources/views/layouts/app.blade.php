...
<body class="font-sans antialiased bg-gray-100">
    ...
    @php
        ...
        $esAdmin = in_array($rol, ['parroco', 'vicario', 'secretaria'], true);
        $esUser = $rol === 'feligres';
    @endphp
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="{{ route('citas.index') }}"
               class="sidebar-nav-item {{ request()->routeIs('citas.*') ? 'active' : '' }}">
                <i class="fas fa-calendar-check"></i> Citas
            </a>

            <a href="{{ route('peticiones.index') }}"
               class="sidebar-nav-item {{ request()->routeIs('peticiones.*') ? 'active' : '' }}">
                <i class="fas fa-hands-praying"></i> Peticiones
            </a>

            @if(Route::has('horarios.index'))
                <a href="{{ route('horarios.index') }}"
                   class="sidebar-nav-item {{ request()->routeIs('horarios.*') ? 'active' : '' }}">
            ...
            @if($esAdmin)
                <a href="{{ route('usuarios.index') }}"
                   class="sidebar-nav-item {{ request()->routeIs('usuarios.*') ? 'active' : '' }}">
                    <i class="fas fa-users"></i> Usuarios
                </a>
            @endif

            @if($esUser && Route::has('profile.index'))
        ...
        <nav class="bg-white shadow-sm sticky top-0 z-50">
            <div class="px-4 py-3 flex justify-between items-center">
                <div class="flex items-center">
                    ...
                    <div class="flex items-center">
                        <i class="fas fa-church text-2xl text-purple-700 mr-2"></i>
        ...
        <footer class="footer-parroquia">
            <div class="container mx-auto px-4 text-center">
                ...
                <p>
                    ...
                    Diego Fernando Escobar Enríquez |
